...
type
  TFormHelper = class
  public
    class function CreateDict(AParent: TWinControl; AAlign: TAlign; AStyle: TComboBoxStyle; AWidth,AHeight: integer; ACaption: string; OnExecute: TNotifyEvent): TComboBox;
...
class function TFormHelper.CreateDict(AParent: TWinControl; AAlign: TAlign; AStyle: TComboBoxStyle; AWidth,AHeight: integer; ACaption: string; OnExecute: TNotifyEvent): TComboBox;
var obj: TWinControl;
begin

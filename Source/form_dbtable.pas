...
uses Winapi.Windows, Winapi.Messages, Classes, Controls, Forms, Vcl.Menus, Vcl.Grids, Vcl.ValEdit, Vcl.DBGrids, Vcl.DBCtrls, Data.DB,
...
begin
  ...
  for j := 0 to FDataSet.ParamCount - 1 do
    begin
...
begin
  if ValueName = '' then
    ...
    Result := FValueList.Values[ValueName];
end;
